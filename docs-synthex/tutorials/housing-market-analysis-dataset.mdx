import { SYNTHEX_GITHUB_URL, SYNTHEX_GENERATE_DATA_URL } from '../../consts';
...
In this tutorial we will use <a href={SYNTHEX_GITHUB_URL} target='_blank' rel='noopener'>Synthex</a> to generate a dataset for Real Estate market analysis.
...
which takes the following arguments (for the full method's documentation, <a href={SYNTHEX_GENERATE_DATA_URL}>see this documentation page</a>):
