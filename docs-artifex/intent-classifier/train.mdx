---
title: Artifex – Train Intent Classification Models without training data
description: Learn how to use Artifex to train Intent Classification Models without training data.
