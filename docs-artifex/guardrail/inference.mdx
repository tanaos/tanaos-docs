---
title: Artifex – Perform Inference with a local Chatbot Guardrail Model, without the need for a GPU
description: Learn how to use Artifex to perform inference with Chatbot Guardrail Models without the need for a GPU, ensuring safe and reliable AI outputs.
